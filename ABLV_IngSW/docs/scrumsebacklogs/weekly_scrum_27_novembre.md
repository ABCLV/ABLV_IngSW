Weekly SCRUM (26/11) o  
Sprint backlog (dal 26/11 al 03/12)  
Note:  
...
* Recuperare la stesura Project Plan  
* Definire il tipo di DB  
* Implementazione base DB  
* Raccolta e popolazione dati  
* Perfezionare il codice generato da Papyrus

2\. Lavoro completato (Done)

* Completato Use case, Class e Sequence diagrams  
* Generato il codice tramite Papyrus  
* Compilato i file default di github  
* Completato schema ER e logico DB
...
* Implementazione base DB  
* Raccolta e popolazione dati  
* Compilazione Project Plan

4\. Impedimenti attuali (Impediments)

* Utilizzo di PlantUML   
* Non completato tutti gli obiettivi  
* Indecisione su assegnazione compiti  
* Troppa dipendenza tra i vari compiti
