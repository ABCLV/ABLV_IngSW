...
public class Keys {
    ...
    public static final UniqueKey<ContrattoRecord> CONTRATTO__PK_CONTRATTO = Internal.createUniqueKey(Contratto.CONTRATTO, DSL.name("pk_CONTRATTO"), new TableField[] { Contratto.CONTRATTO.ID }, true);
    public static final UniqueKey<GaraRecord> GARA__PK_GARA = Internal.createUniqueKey(Gara.GARA, DSL.name("pk_GARA"), new TableField[] { Gara.GARA.ID }, true);
    public static final UniqueKey<IscriveRecord> ISCRIVE__PK_ISCRIVE = Internal.createUniqueKey(Iscrive.ISCRIVE, DSL.name("pk_ISCRIVE"), new TableField[] { Iscrive.ISCRIVE.ID }, true);
    public static final UniqueKey<PartecipaRecord> PARTECIPA__PK_PARTECIPA = Internal.createUniqueKey(Partecipa.PARTECIPA, DSL.name("pk_PARTECIPA"), new TableField[] { Partecipa.PARTECIPA.ID }, true);
    public static final UniqueKey<RecensisceRecord> RECENSISCE__PK_RECENSISCE = Internal.createUniqueKey(Recensisce.RECENSISCE, DSL.name("pk_RECENSISCE"), new TableField[] { Recensisce.RECENSISCE.ID }, true);
    ...
    public static final UniqueKey<SocietaRecord> SOCIETA__SOCIETA_PK = Internal.createUniqueKey(Societa.SOCIETA, DSL.name("SOCIETA_PK"), new TableField[] { Societa.SOCIETA.NOME }, true);
    ...
    public static final UniqueKey<TurnoRecord> TURNO__PK_TURNO = Internal.createUniqueKey(Turno.TURNO, DSL.name("pk_TURNO"), new TableField[] { Turno.TURNO.ID }, true);

    // -------------------------------------------------------------------------
    // FOREIGN KEY definitions
    // -------------------------------------------------------------------------

    public static final ForeignKey<ConcorrenteRecord, SocietaRecord> CONCORRENTE__FK_CONCORRENTE_SOCIETA_PK = Internal.createForeignKey(Concorrente.CONCORRENTE, DSL.name("fk_CONCORRENTE_SOCIETA_PK"), new TableField[] { Concorrente.CONCORRENTE.SOCIETA }, Keys.SOCIETA__SOCIETA_PK, new TableField[] { Societa.SOCIETA.NOME }, true);
    ...
    public static final ForeignKey<GaraRecord, SocietaRecord> GARA__FK_GARA_SOCIETA_PK = Internal.createForeignKey(Gara.GARA, DSL.name("fk_GARA_SOCIETA_PK"), new TableField[] { Gara.GARA.SOCIETA }, Keys.SOCIETA__SOCIETA_PK, new TableField[] { Societa.SOCIETA.NOME }, true);
    ...
    public static final ForeignKey<IscriveRecord, GaraRecord> ISCRIVE__FK_ISCRIVE_PK_GARA = Internal.createForeignKey(Iscrive.ISCRIVE, DSL.name("fk_ISCRIVE_pk_GARA"), new TableField[] { Iscrive.ISCRIVE.GARA }, Keys.GARA__PK_GARA, new TableField[] { Gara.GARA.ID }, true);
    ...
    public static final ForeignKey<PartecipaRecord, TurnoRecord> PARTECIPA__FK_PARTECIPA_PK_TURNO = Internal.createForeignKey(Partecipa.PARTECIPA, DSL.name("fk_PARTECIPA_pk_TURNO"), new TableField[] { Partecipa.PARTECIPA.TURNO }, Keys.TURNO__PK_TURNO, new TableField[] { Turno.TURNO.ID }, true);
    ...
    public static final ForeignKey<RecensisceRecord, GaraRecord> RECENSISCE__FK_RECENSISCE_PK_GARA = Internal.createForeignKey(Recensisce.RECENSISCE, DSL.name("fk_RECENSISCE_pk_GARA"), new TableField[] { Recensisce.RECENSISCE.GARA }, Keys.GARA__PK_GARA, new TableField[] { Gara.GARA.ID }, true);
    ...
    public static final ForeignKey<TurnoRecord, GaraRecord> TURNO__FK_TURNO_PK_GARA = Internal.createForeignKey(Turno.TURNO, DSL.name("fk_TURNO_pk_GARA"), new TableField[] { Turno.TURNO.GARA }, Keys.GARA__PK_GARA, new TableField[] { Gara.GARA.ID }, true);
