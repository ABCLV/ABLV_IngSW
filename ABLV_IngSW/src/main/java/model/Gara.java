...
public class Gara {
	...
	/*
	 * In posizione: - 0, abbiamo il propositore - 1, abbiamo l'accettatore
	 */
	private SoggettoIF[] autori = new SoggettoIF[2];
	...
	/*
	 * Ritorna true se "o" NON è null. Sennò lancia un eccezione e viene catturata
	...
	public void setPropositore(SoggettoIF p) {
	...
	public SoggettoIF[] getAutori() {
		return this.autori;
	}

	public SoggettoIF getPropositore() {
